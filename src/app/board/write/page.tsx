...
export default function BoardWritePage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // 목업: 실제 API 연동 시 imageUrls, videoUrls 전송
    router.push("/board");
  };
  ...
  return (
    <div className="min-h-screen bg-white pt-24 pb-16">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <h1 className="mt-4 text-2xl font-bold text-[#191f28]">글쓰기</h1>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          <div>
            ...
            <input
              ...
              maxLength={200}
              className="mt-2 w-full rounded-lg border border-[#e5e8eb] px-4 py-2.5 text-[15px] placeholder:text-[#8b95a1] focus:border-burgundy focus:outline-none focus:ring-1 focus:ring-burgundy"
              required
            />
          </div>
          <div>
            ...
            <textarea
              ...
              rows={12}
              className="mt-2 w-full resize-y rounded-lg border border-[#e5e8eb] px-4 py-2.5 text-[15px] placeholder:text-[#8b95a1] focus:border-burgundy focus:outline-none focus:ring-1 focus:ring-burgundy"
            />
          </div>
